...
public class UpdateService {
    ...
    public Object update(String id) {
        ...
        UpdateResult result = mongoTemplate.upsert(query, update, Person.class, COLLECTION_NAME);
        // 输出结果信息
    ...
    public Object updateFirst() {
        ...
        // 执行更新
        UpdateResult result = mongoTemplate.updateFirst(query, update, Person.class, COLLECTION_NAME);
        // 输出结果信息
    ...
    public Object updateMany() {
        ...
        // 执行更新
        UpdateResult result = mongoTemplate.updateMulti(query, update, Person.class, COLLECTION_NAME);
        // 输出结果信息
